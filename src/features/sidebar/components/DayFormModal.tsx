      ...
      <div className="bg-surface rounded-t-3xl sm:rounded-3xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto border border-gray-200/80 animate-sheet-up sm:animate-modal-pop" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="p-4 space-y-5">
          ...
          <div>
            ...
            {(destId || searchedDest) && (
              <div className="mb-2 flex items-center gap-2 text-sm bg-primary/5 rounded-xl px-3 py-2 border border-primary/20">
          ...
          <div>
            ...
            <input
              ...
              className="w-full text-sm px-3.5 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary/40 outline-none bg-gray-50/30 focus:bg-white transition-colors"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="w-full text-sm px-3.5 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary/40 outline-none resize-none bg-gray-50/30 focus:bg-white transition-colors"
            />
          </div>
